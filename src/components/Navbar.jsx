        ...
        {token ? (
          <div className="relative">
            ...
            onMouseEnter={toggleDropdown}>
              <img className="w-8 h-8 rounded-full border border-gray-300" src={assets.profile_pic} alt="Profile" />
              <img className="w-4 ml-1" src={assets.dropdown_icon} alt="Dropdown" />
            </div>
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-20" onMouseLeave={toggleDropdown}>
